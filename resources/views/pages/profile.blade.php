    ...
    <body class="bg-gray-100 flex min-h-screen">
                        ...
                        <div
                            ...
                            <div class="flex justify-between">
                                <div class="flex flex-row">
                                    <div>
                                        <img src="{{ asset('storage/' . ($post->user->profile ?? 'profile.png')) }}"
                            ...
                            <div class="flex items-center justify-between mt-4 px-2">
                                ...
                                <div class="flex items-center gap-4">
                                    <a href="/home/post/{{ $post->id }}" class="flex items-center gap-1">
                                        <span
                                            class="material-symbols-outlined text-2xl text-gray-700 cursor-pointer">mode_comment</span>
                                        <span
                                            class="text-gray-500 text-sm font-medium">{{ $post->comments->count() ?? 0 }}</span>
                                    </a>
                                    <span
        ...
        <div id="editProfileModal"
            ...
            <div class="bg-white w-full max-w-2xl rounded-3xl p-6 shadow-xl relative">
                    ...
                    <div class="flex items-start gap-6">
                        <div class="flex flex-col items-center">
                            ...
                            <button type="button" onclick="document.getElementById('profileInput').click()"
                                class="text-sm text-blue-600 mt-2 hover:underline">Ubah Foto Profile</button>
                ...
                <div class="mt-8 text-center">
                    <button type="button" id="showDeleteModal"
                        class="text-red-600 font-bold text-lg hover:underline">Delete Account</button>
                </div>
            </div>
        </div>
        ...
        <div id="myModal"
            ...
            <div class="bg-white rounded-xl p-6 max-w-md w-full shadow-lg">
                ...
                <p class="mb-4 text-gray-700">Apakah Anda yakin ingin menghapus akun Anda? Tindakan ini tidak bisa
                    dibatalkan.</p>
